...
function ProjectCard({
  ...
  return (
    ...
    >
      <div className="w-32 h-20 mr-2 flex flex-col items-center justify-center">
        <Image
          src={thumbnailUrl}
          alt={title}
          width={256} // Match w-64
          height={128} // Match h-32
      ...
      <div className="flex flex-col gap-4">
        <h3>
          ...
          <span className="p-2">
            <GoArrowUpRight
              className={`inline transition-all duration-300 ${isHovered ? "text-accent" : "text-white"}`}
            />
          </span>
        </h3>
